...
const sendEmail = (e) =>{ 
    ...
    emailjs.sendForm('service_szmrjsl', 'template_0b01m3a', '#contact-form', 'DcHbI1TmotTJihPO6')
    .then(() => {
        // Show sent message
...
sr.reveal(`.about__data, .contact__form`, {delay: 300, origin: 'right'})
sr.reveal(`.skills__content, .portfolio__content, .testimonial__content, .footer__content`, {interval: 100})
